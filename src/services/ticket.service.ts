...
import { TicketPriority, TicketStatus ,Ticket , Attachment} from "@/types";
...
export interface UpdateTicketPayload {
  ...
  removeAttachments?: number[]; // Array of attachment IDs to remove
}
...
export const updateTicket = async (
  ...
  const res = await authFetch(
    `${import.meta.env.VITE_API_BASE_URL}/tickets/${ticketId}/update`,
    {
      method: "PATCH",
      body: JSON.stringify(payload),
    }
